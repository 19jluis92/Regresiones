CREATE DATABASE  IF NOT EXISTS `resultados` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `resultados`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: resultados
-- ------------------------------------------------------
...
CREATE TABLE `lineal` (
  ...
  `ordenada` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idlineal_UNIQUE` (`id`)
...
INSERT INTO `lineal` VALUES (1,0.00215987,18.298);
...
-- Dump completed on 2018-10-04 20:00:23
